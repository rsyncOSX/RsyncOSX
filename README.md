...
| [RawCull (AI)](#rawcull) | AI-assisted Sony RAW photo culling | Apple Silicon, macOS Golden Gate beta, version 3.1.1 is next version and will only run on macOS Golden Gate |
...
RawCull version 3.1.1 is available via Apple’s TestFlight; please email thomeven@gmail.com if you would like to try it through that service.
...
[Download from the Mac App Store](https://apps.apple.com/no/app/rawcull/id6759362764?mt=12) · [GitHub releases](https://github.com/rsyncOSX/RawCull/releases) · [Download RawCull (AI) v3.1.1 beta](https://github.com/rsyncOSX/RawCull/releases/tag/v3.1.1) · [Documentation](https://rawcull.netlify.app/docs/) · [Release notes](https://rawcull.netlify.app/blog/)

**Requires Apple Silicon.** The current release, v2.3.5, supports macOS Tahoe and later. The [RawCull (AI) v3.1.1 beta](https://github.com/rsyncOSX/RawCull/releases/tag/v3.1.1) with AI-powered features is available for macOS Golden Gate beta. See the [documentation](https://rawcull.netlify.app/docs/) for supported Sony full-frame camera bodies.
...
**Requires Apple Silicon and macOS Golden Gate beta.** The latest release is [v2.4.3](https://github.com/rsyncOSX/RawCullFB/releases), released August 18, 2026. RawCullFB is sandboxed, signed, and notarized by Apple.
