...
There is also an AI based version of RawCull. The AI version is a branch of the main RawCull repository, and there is a copy of the [AI branch on GitHub](https://github.com/rsyncOSX/RawCullAI).
...
| --- | --- |
| macOS Sequoia, **Apple Silicon** (M-series) only | v2.3.1 — July 23, 2026 — *active development* |
